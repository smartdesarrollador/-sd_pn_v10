...
class SettingsWindow(QDialog):
    ...
    def init_ui(self):
        ...
        self.tab_widget.addTab(self._create_scrollable_tab(self.category_editor), "Categorías")
        self.tab_widget.addTab(self._create_scrollable_tab(self.appearance_settings), "Apariencia")
        self.tab_widget.addTab(self._create_scrollable_tab(self.hotkey_settings), "Hotkeys")
    ...
    def _create_scrollable_tab(self, widget):
        """
        Wrap a widget in a scroll area for the tab
